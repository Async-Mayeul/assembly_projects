...
;
;ne gère pas un flux d'entrée supérieur à 1000 caractères
;
;------------------------------------------------------------
...
segment .bss
    entier: resd 1  				;place pour un entier lu
...
read_int:
    ...
    add edx,[fin_flot]
    add ecx,[debut_flot]
; sauter caractère blanc tampon jusqu'à non blanc ou vide
loop:
    cmp ecx,edx
    jne  suite
    call tampon
